...
(function () {
    ...
    va.prototype = {init: function (a, b) {
        ...
        if (la(a))c = a, h === "circle" ? c = {x: "cx", y: "cy"}[c] || c : c === "strokeWidth" && (c = "stroke-width"), u = z(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && (u = parseFloat(u)); else for (c in a)if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
            e !== x && (d = e);
    ...
    ra.prototype = {Element: va, init: function (a, b, c, d) {
        ...
        var h = this.label(a, b, c), i = 0, j, k, l, m, p, a = {x1: 0, y1: 0, x2: 0, y2: 1}, e = A(ka("stroke-width", 1, "stroke", "#999", "fill", ka("linearGradient", a, "stops", [
            [0, "#FFF"],
            [1, "#DDD"]
        ...
        if (g) {
            ...
            if (!c.id || !h[c.id])Ha(c) && (a[g] = c = {x1: c[0], y1: c[1], x2: c[2], y2: c[3], gradientUnits: "userSpaceOnUse"}), g === "radialGradient" && b && !t(c.gradientUnits) && r(c, {cx: b[0] - b[2] / 2 + c.cx * b[2], cy: b[1] - b[2] / 2 + c.cy * b[2], r: c.r * b[2], gradientUnits: "userSpaceOnUse"}), c.id = "highcharts-" + ub++, h[c.id] = i = d.createElement(g).attr(c).add(d.defs), i.stops = [], n(a.stops, function (a) {
    ...
    ob.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M", hour: "%H:%M", day: "%e. %b", week: "%e. %b", month: "%b '%y", year: "%Y"}, endOnTick: !1, gridLineColor: "#C0C0C0",
        ...
        if (b || a.isLinked)n(e, function (b) {
            ...
            if (h === 0 || h === 2 || {1: "left",
                3: "right"}[h] === p.align)u = y(f[a].getLabelSize(), u)
    ...
    pb.prototype = {destroy: function () {
        ...
        if (p) {
            p = na(p);
            for (e = p.length; e--;)if (i = a.series[e ? "yAxis" : "xAxis"], p[e] && i)if (i = i.getPlotLinePath(e ? o(a.stackY, a.y) : a.x, 1), this.crosshairs[e])this.crosshairs[e].attr({d: i, visibility: "visible"}); else {
    ...
    rb.prototype = {init: function (a) {
        ...
        if (!q && (a.legendGroup = d.g("legend-item").attr({zIndex: 1}).add(b.scrollGroup),
            ...
            a.visible), r && s))a.checkbox = Q("input", {type: "checkbox", checked: a.selected, defaultChecked: a.selected}, e.itemCheckboxStyle, c.container), I(a.checkbox, "click", function (b) {
        ...
        d > c && (d = c);
        if (d > 0)b !== x && ua(b, this.chart), this.nav.attr({translateX: i, translateY: e + 7, visibility: "visible"}), this.up.attr({fill: d ===
    ...
    sb.prototype = {initSeries: function (a) {
        ...
        resetMargins: function () {
            ...
            if (m)g ? g.animate(g.crisp(null, o, n, q, r)) : this.plotBorder = b.rect(o, n, q, r, 0, m).attr({stroke: a.plotBorderColor, "stroke-width": m, zIndex: 1}).add();
            this.isDirtyBox = !1
    ...
    N.prototype = {isCartesian: !0, type: "line", pointClass: Ta, sorted: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, init: function (a, b) {
        ...
        if (l.enabled || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled ===
            x || i.enabled, m = c.isInsidePlot(d, e, c.inverted), a && e !== x && !isNaN(e))if (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = o(i.symbol, this.symbol), j = i.indexOf("url") === 0, k)k.attr({visibility: m ? Z ? "inherit" : "visible" : "hidden"}).animate(r({x: d - h, y: e - h}, k.symbolName ? {width: 2 * h, height: 2 * h} : {})); else {
    ...
    ha = ca(N, {type: "column", tooltipOutsidePlot: !0, pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color", r: "borderRadius"}, init: function () {
        ...
        n(a.points, function (h) {
            ...
            if (h.y !== null && m)e ? e.attr(d) : h.tracker = c[h.shapeType](d).attr({isTracker: f,
        ...
        if (a.shapeArgs && (d = A(a.shapeArgs), g && (d = {x: f.plotWidth - d.y - d.height, y: f.plotHeight - d.x - d.width, width: d.height, height: d.width}), !i))g ? (d.x += h ? 0 : d.width, d.width = 0) : (d.y += h ? d.height : 0, d.height = 0);
    ...
    ya = {type: "pie", isCartesian: !1, pointClass: ca(Ta,
        ...
        var a = this.data, b, c = this.chart, d = this.options.dataLabels, e = o(d.connectorPadding, 10), f = o(d.connectorWidth, 1), g, h, i = o(d.softConnector, !0), j = d.distance, k = this.center, l = k[2] / 2, m = k[1], p = j > 0, r = [
            [],
            []
        ], s, q, t, w, y = 2, v;
