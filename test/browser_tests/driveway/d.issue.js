...
exports.goIndex = function (rider, callback) {
    rider.get(url.base + 'issue').then(callback);
};


exports.addModel = function (rider, values, callback) {
    rider.findById('issue-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider.findById('issue-add-btn').click();
            rider.findAllBySelector('ul#issue_list li')
                .then(function (li) {
...
exports.searchModel = function (rider, searchWord, callback) {
    rider.findById('issue-list-form')
        ...
        .then(function () {
            return rider.findById('issue_list')
                .then(function (ul) {
                    var result = [];
