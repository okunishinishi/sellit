...
exports.goIndex = function (rider, callback) {
    rider.get(url.base + 'salesman').then(callback);
};


exports.addModel = function (rider, values, callback) {
    rider.findById('salesman-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider.findById('salesman-add-btn').click();
            rider.findAllBySelector('ul#salesman_list li')
                .then(function (li) {
...
exports.updateModel = function (rider, values, callback) {
    rider
        .findById('salesman-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider
                .findById('salesman_list')
...
exports.searchModel = function (rider, searchWord, callback) {
    rider.findById('salesman-list-form')
        ...
        .then(function () {
            return rider.findById('salesman_list')
                .then(function (ul) {
                    var result = [];
