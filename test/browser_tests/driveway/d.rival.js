...
exports.goIndex = function (rider, callback) {
    rider.get(url.base + 'rival').then(callback);
};


exports.addModel = function (rider, values, callback) {
    rider.findById('rival-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider.findById('rival-add-btn').click();
            rider.findAllBySelector('ul#rival_list li')
                .then(function (li) {
...
exports.searchModel = function (rider, searchWord, callback) {
    rider.findById('rival-list-form')
        ...
        .then(function () {
            return rider.findById('rival_list')
                .then(function (ul) {
                    var result = [];
