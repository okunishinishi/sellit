...
exports.goIndex = function (rider, callback) {
    rider.get(url.base + 'system').then(callback);
};


exports.addModel = function (rider, values, callback) {
    rider.findById('system-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider.findById('system-add-btn').click();
            rider.findAllBySelector('ul#system_list li')
                .then(function (li) {
...
exports.updateModel = function (rider, values, callback) {
    rider
        .findById('system-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider
                .findById('system_list')
...
exports.searchModel = function (rider, searchWord, callback) {
    rider.findById('system-list-form')
        ...
        .then(function () {
            return rider.findById('system_list')
                .then(function (ul) {
                    var result = [];
