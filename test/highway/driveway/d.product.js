...
exports.goIndex = function (rider, callback) {
    rider.get(url.base + 'product').then(callback);
};


exports.addModel = function (rider, values, callback) {
    rider.findById('product-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider.findById('product-add-btn').click();
            rider.findAllBySelector('ul#product_list li')
                .then(function (li) {
...
exports.updateModel = function (rider, values, callback) {
    rider
        .findById('product-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider
                .findById('product_list')
...
exports.searchModel = function (rider, searchWord, callback) {
    rider.findById('product-list-form')
        ...
        .then(function () {
            return rider.findById('product_list')
                .then(function (ul) {
                    var result = [];
