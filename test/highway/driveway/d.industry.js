...
exports.goIndex = function (rider, callback) {
    rider.get(url.base + 'industry').then(callback);
};


exports.addModel = function (rider, values, callback) {
    rider.findById('industry-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider.findById('industry-add-btn').click();
            rider.findAllBySelector('ul#industry_list li')
                .then(function (li) {
...
exports.updateModel = function (rider, values, callback) {
    rider
        .findById('industry-list-form')
        .then(function (form) {
            rider.waitToClassRemove(form, 'tk-loading')
        })
        .then(function () {
            rider
                .findById('industry_list')
...
exports.searchModel = function (rider, searchWord, callback) {
    rider.findById('industry-list-form')
        ...
        .then(function () {
            return rider.findById('industry_list')
                .then(function (ul) {
                    var result = [];
